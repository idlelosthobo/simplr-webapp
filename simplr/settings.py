"""
Django settings for simplr project.
...
SECRET_KEY = 'k-v!ohm846^s0i5*z&xoj**_02l2$$dd47@6wumpae*l$%=f@+'
...
INSTALLED_APPS = [
    ...
    'app.container.apps.ContainerConfig',
...
WSGI_APPLICATION = 'simplr.wsgi.application'
